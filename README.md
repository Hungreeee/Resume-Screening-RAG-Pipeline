...
The research is part of the author's Bachelor's thesis. It aims to propose a POC of an LLM assistant that can assist hiring managers in resume screening. The core design of the assistant involves the use of Retrieval Augmented Generation (RAG) Fusion:
